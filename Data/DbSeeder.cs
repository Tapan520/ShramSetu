...
public static class DbSeeder
{
    public static async Task SeedAsync(IServiceProvider services)
    {
        ...
        db.Notifications.AddRange(
            ...
            new() { Id=Guid.NewGuid(), UserId=workerEntities[0].UserId!, RecipientUserId=workerEntities[0].UserId!, Title="?? Payment Received",                Message="₹10,500 has been credited to your ShramSetu wallet.", ActionUrl="/Workers/Wallet",      IsRead=true,  CreatedAt=DateTime.UtcNow.AddDays(-24) },
            new() { Id=Guid.NewGuid(), UserId=workerEntities[1].UserId!, RecipientUserId=workerEntities[1].UserId!, Title="?? New Job Match",                    Message="A new Electrician job in Delhi matches your profile. ₹900/day for 30 days.", ActionUrl="/Jobs/Index",      IsRead=false, CreatedAt=DateTime.UtcNow.AddDays(-1)  },
            new() { Id=Guid.NewGuid(), UserId=workerEntities[5].UserId!, RecipientUserId=workerEntities[5].UserId!, Title="? Salary Advance Approved",          Message="Your advance of ₹3,500 has been approved by GreenCity Infra.", ActionUrl="/Workers/Wallet",           IsRead=false, CreatedAt=DateTime.UtcNow.AddDays(-7)  },
